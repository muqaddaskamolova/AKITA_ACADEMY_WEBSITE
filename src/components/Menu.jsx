...
function Menu() {
  ...
  return (
    <div className="header w-full">
      <div className="header-wrapper container flex flex-col lg:flex-row items-center justify-between py-4 lg:py-0">
        ...
        {/* Nav Links */}
        <div className="header-innerWrapper flex flex-col lg:flex-row items-center mt-4 lg:mt-0 space-y-2 lg:space-y-0">
          <span className="header-span bg-green-200 p-2 rounded-md text-center lg:text-left">
            {t("logo-text")}
          </span>
          
          <nav className="header-nav navbar text-green-400 bg-green-100 rounded-lg p-3 shadow-lg transition duration-300 ease-in-out hover:shadow-xl lg:ml-2">
